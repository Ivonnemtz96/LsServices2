                    ...
                    <div class="col-lg-8 col-md-1 col-1">
                        <div id="navbar" class="collapse navbar-collapse navigation-holder">
                            ...
                            <ul class="nav navbar-nav mb-2 mb-lg-0">
                                <li>
                                    <a class="<?php echo $inicio ?>" href="index.php">Home</a>
                                    <!-- <ul class="sub-menu">
                                ...
                                <li class="menu-item-has-children">
                                    <a class="<?php echo $menu ?>" href="#">Menus</a>
                                    <ul class="sub-menu">
                                ...
                                <li>
                                    <a class="<?php echo $services ?>" href="services.php">Services</a>
                                </li>
                                <li>
                                    <a class="<?php echo $contact ?>" href="contact.php">Contact us</a>
                                </li>
                                <li>
                                    <a class="<?php echo $gallery ?>" href="galeria.php">Gallery</a>
                                </li>
                                <!-- <li class="menu-item-has-children">
