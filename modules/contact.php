                    ...
                    <div class="col col-lg-10 offset-lg-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col col-xl-4 col-lg-6 col-md-6 col-12">
                                    <div class="office-info-item">
                                        ...
                                        <div class="office-info-text">
                                            <h2>Email Us</h2>
                                            <p><a style="color:#848892" href="mailto:serviciospi@hotmail.com">serviciospi@hotmail.com</a></p>
                                        </div>
                                    </div>
                                </div> 
                                <div class="col col-xl-4 col-lg-6 col-md-6 col-12">
                                    <div class="office-info-item">
                                        ...
                                        <div class="office-info-text">
                                            <h2>Call Now</h2>
                                            <p><a style="color:#848892" href="tel:+526241297417">+52 624 129 7417</a></p>
                                        </div>
                                    </div>
                                </div> 
                            </div>
                        ...
                        <div class="wpo-contact-form-area">
                            <form method="post" class="contact-validation-active" id="contact-form-main">
                                ...
                                <div>
                                    <input type="text" class="form-control" name="adress" id="adress" placeholder="Your adress*">
                                </div>
                                <div>
                                ...
                                <div class="submit-area">
                                    <button type="submit" class="theme-btn-s4">Send</button>
                                    <div id="loader">
                                        <i class="ti-reload"></i>
                                    </div>
                                </div>
