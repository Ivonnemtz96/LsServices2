                            ...
                            <div class="container-fluid">
                                <div class="slide-content">
                                    ...
                                    <div data-swiper-parallax="400" class="slide-text">
                                        <p>Creating great experiences since 2000</p>
                                    </div>
                        ...
                        <div class="wpo-about-text">
                            ...
                            <div class="wpo-about-icon-content">
                                ...
                                <p hidden>
                                    ...
                                    model text.</p>
                                <a class="theme-btn-s3" href="services.php">Services</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-12 col-12">
                        <div class="wpo-about-wrap">
                            ...
                            <div class="ab-shape">
                                <img style="opacity: 40%;" src="assets/images/about/shape.png" alt="">
                            </div>
                        </div>
                    </div>
        ...
        <section class="wpo-service-section pt-70">
            <h2 class="hidden">LS Services</h2>
            <div class="container">
        ...
        <!-- start story-section -->
        <section hidden class="story-section section-padding" id="story">
            <div class="container">
                <div class="row">
        ...
        <section hidden class="wpo-portfolio-section-s2 section-padding" id="gallery">
            <div class="container-fluid">
                <div class="row">
                    <div class="wpo-section-title-s2">
                        <div class="section-title-simg">
        ...
        <div class="wpo-cta-section-s3" style="margin-bottom: 10rem;">
            <div class="conatiner-fluid">
                <div class="wpo-cta-item">
                    <h2>Adventure Begins</h2>
                    <!-- <p>Nov 22,2021, Wedding Unity Center, road 525 USA</p> -->
                    <a class="theme-btn-s2" href="services.php">View more</a>
                </div>
            </div>
        </div>
        ...
        <section hidden class="wpo-event-section section-padding" id="event">
            <div class="container">
                <div class="row">
                    <div class="wpo-section-title-s2">
                        <div class="section-title-simg">
        ...
        <section hidden class="wpo-partners-section-s3">
